...
/**
 * The channel used to send the payment message. if `customerEmail` or `customerPhone` is provided this parameter is ignored. 
 * @export
 * @enum {string}
 */
...
/**
 * Controls when the funds will be captured.   - `SALE` - **Default**. MONEI automatically captures funds     when the customer authorizes the payment.   - `AUTH` - Place a hold on the funds when the customer authorizes     the payment, but don’t capture the funds until later.   - `PAYOUT` - Send funds to the customer 
 * @export
 * @enum {string}
 */
