...
/**
    ...
    * @enum {string}
    */
export enum SendSubscriptionLinkRequestChannelEnum {
    email = 'email',
    sms = 'sms'
}
...
/**
    ...
    * @enum {string}
    */
export enum SendSubscriptionStatusRequestChannelEnum {
    email = 'email',
    sms = 'sms'
}
 ...
 */
export interface SubscriptionRetrySchedule extends Array<object> {
}
/**
...
export const ApplePayDomainApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        register: async (registerApplePayDomainRequest: RegisterApplePayDomainRequest, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'registerApplePayDomainRequest' is not null or undefined
            if (registerApplePayDomainRequest === null || registerApplePayDomainRequest === undefined) {
                throw new RequiredError('registerApplePayDomainRequest','Required parameter registerApplePayDomainRequest was null or undefined when calling register.');
            }
            ...
            const needsSerialization = (typeof registerApplePayDomainRequest !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data =  needsSerialization ? JSON.stringify(registerApplePayDomainRequest !== undefined ? registerApplePayDomainRequest : {}) : (registerApplePayDomainRequest || "");
...
export const ApplePayDomainApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async register(registerApplePayDomainRequest: RegisterApplePayDomainRequest, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse200>> {
            const localVarAxiosArgs = await ApplePayDomainApiAxiosParamCreator(configuration).register(registerApplePayDomainRequest, options);
...
export const ApplePayDomainApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        register(registerApplePayDomainRequest: RegisterApplePayDomainRequest, options?: any): AxiosPromise<InlineResponse200> {
            return ApplePayDomainApiFp(configuration).register(registerApplePayDomainRequest, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class ApplePayDomainApi extends BaseAPI {
     ...
     */
    public register(registerApplePayDomainRequest: RegisterApplePayDomainRequest, options?: any) {
...
export const PaymentMethodsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        get: async (accountId?: string, paymentId?: string, options: any = {}): Promise<RequestArgs> => {
...
export const PaymentMethodsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async get(accountId?: string, paymentId?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PaymentMethods>> {
            const localVarAxiosArgs = await PaymentMethodsApiAxiosParamCreator(configuration).get(accountId, paymentId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const PaymentMethodsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        get(accountId?: string, paymentId?: string, options?: any): AxiosPromise<PaymentMethods> {
            return PaymentMethodsApiFp(configuration).get(accountId, paymentId, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class PaymentMethodsApi extends BaseAPI {
     ...
     */
    public get(accountId?: string, paymentId?: string, options?: any) {
...
export const PaymentsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        sendRequest: async (id: string, sendPaymentRequestRequest: SendPaymentRequestRequest, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
            ...
            if (sendPaymentRequestRequest === null || sendPaymentRequestRequest === undefined) {
                throw new RequiredError('sendPaymentRequestRequest','Required parameter sendPaymentRequestRequest was null or undefined when calling sendRequest.');
            }
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            const needsSerialization = (typeof sendPaymentRequestRequest !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data =  needsSerialization ? JSON.stringify(sendPaymentRequestRequest !== undefined ? sendPaymentRequestRequest : {}) : (sendPaymentRequestRequest || "");
...
export const PaymentsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async sendRequest(id: string, sendPaymentRequestRequest: SendPaymentRequestRequest, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Payment>> {
            const localVarAxiosArgs = await PaymentsApiAxiosParamCreator(configuration).sendRequest(id, sendPaymentRequestRequest, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const PaymentsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        sendRequest(id: string, sendPaymentRequestRequest: SendPaymentRequestRequest, options?: any): AxiosPromise<Payment> {
            return PaymentsApiFp(configuration).sendRequest(id, sendPaymentRequestRequest, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class PaymentsApi extends BaseAPI {
     ...
     * @memberof PaymentsApi
     */
    public sendRequest(id: string, sendPaymentRequestRequest: SendPaymentRequestRequest, options?: any) {
...
export const SubscriptionsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        sendLink: async (id: string, sendSubscriptionLinkRequest?: SendSubscriptionLinkRequest, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling sendLink.');
            }
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            const needsSerialization = (typeof sendSubscriptionLinkRequest !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data =  needsSerialization ? JSON.stringify(sendSubscriptionLinkRequest !== undefined ? sendSubscriptionLinkRequest : {}) : (sendSubscriptionLinkRequest || "");
         ...
         * @throws {RequiredError}
         */
        sendStatus: async (id: string, sendSubscriptionStatusRequest?: SendSubscriptionStatusRequest, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling sendStatus.');
            }
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            const needsSerialization = (typeof sendSubscriptionStatusRequest !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data =  needsSerialization ? JSON.stringify(sendSubscriptionStatusRequest !== undefined ? sendSubscriptionStatusRequest : {}) : (sendSubscriptionStatusRequest || "");
...
export const SubscriptionsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async activate(id: string, activateSubscriptionRequest?: ActivateSubscriptionRequest, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Subscription>> {
         ...
         * @throws {RequiredError}
         */
        async sendLink(id: string, sendSubscriptionLinkRequest?: SendSubscriptionLinkRequest, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Subscription>> {
            const localVarAxiosArgs = await SubscriptionsApiAxiosParamCreator(configuration).sendLink(id, sendSubscriptionLinkRequest, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async sendStatus(id: string, sendSubscriptionStatusRequest?: SendSubscriptionStatusRequest, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Subscription>> {
            const localVarAxiosArgs = await SubscriptionsApiAxiosParamCreator(configuration).sendStatus(id, sendSubscriptionStatusRequest, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const SubscriptionsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        activate(id: string, activateSubscriptionRequest?: ActivateSubscriptionRequest, options?: any): AxiosPromise<Subscription> {
         ...
         * @throws {RequiredError}
         */
        sendLink(id: string, sendSubscriptionLinkRequest?: SendSubscriptionLinkRequest, options?: any): AxiosPromise<Subscription> {
            return SubscriptionsApiFp(configuration).sendLink(id, sendSubscriptionLinkRequest, options).then((request) => request(axios, basePath));
        },
        /**
         * <p>Sends subscription status information to the customer through their preferred communication channel.</p> <p><strong>This API can only be used for subscriptions with the following statuses:</strong></p> <ul> <li>Active</li> <li>Trialing</li> <li>Past due</li> </ul> <p><strong>Delivery channels are automatically selected based on available customer information:</strong></p> <ul> <li>If customer email is available: Status is sent via email</li> <li>If customer phone is available: Status is sent via WhatsApp</li> <li>If WhatsApp delivery fails: Status is sent via SMS as a fallback</li> </ul> <p>The status notification includes subscription details such as current status, upcoming payments, and recent changes. If no customer contact information is provided, the system will use the details stored in the subscription record.</p> <p><strong>Email notifications include contextual action links based on subscription status:</strong></p> <ul> <li>For past due subscriptions: A link to reactivate the subscription</li> <li>For active and trialing subscriptions: A link to update the payment method</li> </ul> <p>You can specify the customer&#39;s email or phone number, the preferred communication channel (email or SMS), and the language for the message. </p> 
         * @summary Send Subscription Status
         ...
         * @throws {RequiredError}
         */
        sendStatus(id: string, sendSubscriptionStatusRequest?: SendSubscriptionStatusRequest, options?: any): AxiosPromise<Subscription> {
            return SubscriptionsApiFp(configuration).sendStatus(id, sendSubscriptionStatusRequest, options).then((request) => request(axios, basePath));
        },
        /**
         * <p>Updates the configuration of an existing subscription.</p> <p><strong>Modifiable Parameters</strong>:</p> <ul> <li>Billing information (amount, description)</li> <li>Customer details (contact information, billing/shipping addresses)</li> <li>Subscription settings (cancelAtPeriodEnd, pauseAtPeriodEnd)</li> <li>Metadata (for your internal tracking)</li> </ul> <p><strong>Update Effects</strong>:</p> <ul> <li>Amount changes apply to the next billing cycle</li> <li>Customer information updates take effect immediately</li> <li>Setting <code>cancelAtPeriodEnd</code> to true will end the subscription after the current period</li> <li>Setting <code>pauseAtPeriodEnd</code> to true will pause billing after the current period</li> </ul> <p><strong>Note</strong>: Some fundamental properties cannot be changed once a subscription is created, including currency and billing interval. To modify these, you would need to cancel the  existing subscription and create a new one. </p> 
         * @summary Update Subscription
...
export class SubscriptionsApi extends BaseAPI {
     ...
     * @memberof SubscriptionsApi
     */
    public sendLink(id: string, sendSubscriptionLinkRequest?: SendSubscriptionLinkRequest, options?: any) {
     ...
     * @memberof SubscriptionsApi
     */
    public sendStatus(id: string, sendSubscriptionStatusRequest?: SendSubscriptionStatusRequest, options?: any) {
