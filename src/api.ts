...
export const ApplePayDomainApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * <p>Registers custom domain for Apple Pay.</p> <p>Download this <a href=\"https://assets.monei.com/apple-pay/apple-developer-merchantid-domain-association/\" target=\"_blank\">domain association file</a> and host it at <code>/.well-known/apple-developer-merchantid-domain-association</code> on your site.</p> <p>For example, if you’re registering <a href=\"https://example.com\" target=\"_blank\">https://example.com</a>, make that file available at <a href=\"https://example.com/.well-known/apple-developer-merchantid-domain-association\" target=\"_blank\">https://example.com/.well-known/apple-developer-merchantid-domain-association</a>.</p>
         * @summary Register
         * @param {InlineObject} inlineObject 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        register: async (inlineObject: InlineObject, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'inlineObject' is not null or undefined
            if (inlineObject === null || inlineObject === undefined) {
                throw new RequiredError('inlineObject','Required parameter inlineObject was null or undefined when calling register.');
            }
...
export const ApplePayDomainApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async register(inlineObject: InlineObject, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse200>> {
            const localVarAxiosArgs = await ApplePayDomainApiAxiosParamCreator(configuration).register(inlineObject, options);
...
export const ApplePayDomainApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        register(inlineObject: InlineObject, options?: any): AxiosPromise<InlineResponse200> {
            return ApplePayDomainApiFp(configuration).register(inlineObject, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class ApplePayDomainApi extends BaseAPI {
    ...
    public register(inlineObject: InlineObject, options?: any) {
        return ApplePayDomainApiFp(this.configuration).register(inlineObject, options).then((request) => request(this.axios, this.basePath));
    }
...
export const SubscriptionsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * Activates the subscription that was previously created. Activation of the subscription will create an initial payment. If the subscription has trial period, the initial payment will have zero amount. The subscription is automatically activated when initial payment is confirmed. <br/><br/> If the subscription is already activated, this endpoint can be used to update payment method. This will also generate zero amount payment.
        ...
        /**
         * Creates a new subscription. Subscription is created with status: `PENDING`. In order to activate it you need to call <a href=\"#operation/subscriptions_activate\">activate endpoint</a>.
