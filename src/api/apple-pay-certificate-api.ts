...
// @ts-ignore
import type {ApplePayCertificateDelete200Response} from '../model';
// @ts-ignore
  ...
  return {
    ...
    async _delete(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<ApplePayCertificateDelete200Response>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator._delete(id, options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['ApplePayCertificateApi._delete']?.[localVarOperationServerIndex]?.url;
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['ApplePayCertificateApi.list']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export const ApplePayCertificateApiFactory = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    list(options?: RawAxiosRequestConfig): AxiosPromise<Array<ApplePayCertificate>> {
