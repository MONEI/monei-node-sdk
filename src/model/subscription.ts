...
// May contain unused imports in some cases
// @ts-ignore
import type { SubscriptionLastProration } from "./subscription-last-proration";
// May contain unused imports in some cases
// @ts-ignore
...
export interface Subscription {
  ...
  /**
   * The date of the most recent prorated change. A period can be prorated more than once, so this moves with each settlement rather than being set once per period.
   * @type {number}
   * @memberof Subscription
   */
  lastProrationAt?: number;
  /**
   *
   * @type {SubscriptionLastProration}
   * @memberof Subscription
   */
  lastProration?: SubscriptionLastProration;
  /**
   *
